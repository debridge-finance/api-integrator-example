...
async function main() {
  ...
  const amountToSend = "1.2"; // The amount of USDC to send
  const solUserAddress = "862oLANNqhdXyUCwLJPBqUHrScrqNR4yoGWGTxjZftKs"

  const raydiumAuthorityPda = "5Q544fKrFoe6tsEbD7S8EmxGTJYAKtTVhAW5Q5pge4j1";
  ...
  const orderInput: deBridgeOrderInput = {
    ...
    dstChainTokenOutRecipient: raydiumAuthorityPda,
    ...
    skipSolanaRecipientValidation: true // Necessary, since the recipient is a PDA 
  };
